...
func TestMakeJotter(t *testing.T) {
	t.Run("default construction", func(t *testing.T) {
		...
		if jotter.Level() != DefaultLevel {
			t.Errorf("Expected default level %v, got %v", DefaultLevel, jotter.Level())
		}
	...
	t.Run("with custom leveler", func(t *testing.T) {
		jotter := MakeJotter(WithLeveler(slog.LevelDebug))
...
func TestWithLeveler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			jotter := MakeJotter(WithLeveler(tt.level))
...
func TestWithHandler(t *testing.T) {
	...
	jotter := MakeJotter(WithHandler(handler))
...
func TestWithText(t *testing.T) {
	...
	jotter := MakeJotter(WithText(&buf, opts))
...
func TestWithJSON(t *testing.T) {
	...
	jotter := MakeJotter(WithJSON(&buf, opts))
...
func TestJotterEnabled(t *testing.T) {
	jotter := MakeJotter(WithLeveler(slog.LevelWarn))
...
func TestJotterWithAttrs(t *testing.T) {
	var buf bytes.Buffer
	jotter := MakeJotter(WithText(&buf, nil))
...
func TestJotterPreventSelfReference(t *testing.T) {
	...
	jotter1 := MakeJotter()
	jotter2 := MakeJotter(WithLeveler(jotter1))
	...
	jotter3 := MakeJotter(WithHandler(jotter1))
